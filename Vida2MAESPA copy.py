...
if __name__ == '__main__':
	...
	parser.add_argument('-f', metavar='file', type=file, dest='eventFile', required=False, help='Load an event file')   
	parser.add_argument('-ff', metavar='directory', dest='theDirectory', required=False, help='Directory Vida files are found in') 
